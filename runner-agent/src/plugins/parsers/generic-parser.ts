 ...
 */
function detectPermissionPrompt(_output: string): ParsedApproval | null {
 ...
 */
function detectBypassWarning(_output: string): boolean {
    return false;
}
...
export const genericParser: CliParser = {
    name: 'GenericParser',
    cliType: 'generic',
    detectReady,
